...
function getSearch(res, query, limit, skip) {
    return _event2.default.find(query).sort({ 'favorite': -1, 'startDate': '-1' }).limit(limit).skip(skip).populate('eventType performer location website').exec(function (err, events) {
